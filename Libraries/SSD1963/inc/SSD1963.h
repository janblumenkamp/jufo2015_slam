...
//SOURCE: http://blog.tkjelectronics.dk/2010/05/stm32-and-7-display/
/*****************************************************************************
...
#define Set_Cs  GPIO_SetBits(DIR_GPIO,LCD_CS);
#define Clr_Cs  GPIO_ResetBits(DIR_GPIO,LCD_CS);

#define Set_Rs  GPIO_SetBits(DIR_GPIO,LCD_RS);
#define Clr_Rs  GPIO_ResetBits(DIR_GPIO,LCD_RS);

#define Set_nWr GPIO_SetBits(DIR_GPIO,LCD_WR);
#define Clr_nWr GPIO_ResetBits(DIR_GPIO,LCD_WR);

#define Set_Rst GPIO_SetBits(DIR_GPIO,LCD_RST);
#define Clr_Rst GPIO_ResetBits(DIR_GPIO,LCD_RST);

#define Set_nRd GPIO_SetBits(DIR_GPIO,LCD_RD);
#define Clr_nRd GPIO_ResetBits(DIR_GPIO,LCD_RD);
...
* Note: none
********************************************************************/
/*#define LCD_WriteCommand(cmd) \
{\
	Clr_Rs; \
	DB0TO7GPIO->ODR=(((DB0TO7GPIO->ODR)&0x00ff)|((cmd)<<8)); \
	DB8TO15GPIO->ODR=(((DB8TO15GPIO->ODR)&0xff00)|((cmd)>>8)); \
	Clr_Cs; \
	Clr_nWr; \
	Set_nWr; \
	Set_Cs; \
...
{ \
	Set_Rs; \
	DB0TO7GPIO->ODR=(((DB0TO7GPIO->ODR)&0x00ff)|((data)<<8)); \
	DB8TO15GPIO->ODR=(((DB8TO15GPIO->ODR)&0xff00)|((data)>>8)); \
	Clr_nWr; \
	Set_nWr; \
};*/
...
*
********************************************************************/
void LCD_PutPixel(int16_t x, int16_t y, u16 color);
...
*
********************************************************************/
void LCD_SetClipRgn(int16_t left,int16_t top,int16_t right,int16_t bottom);
...
* Note:
********************************************************************/
void LCD_SetTearingCfg(u8 state, u8 mode);
