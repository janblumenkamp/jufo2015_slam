...
void LCD_ResetDevice(void)
{
	...
	RCC_AHB1PeriphClockCmd(DB0TO7RCC, ENABLE);
	RCC_AHB1PeriphClockCmd(DB0TO7RCC, ENABLE);
	...
	GPIO_Init(DB8TO15GPIO, &GPIO_InitStructure);

    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0|GPIO_Pin_1|GPIO_Pin_2|GPIO_Pin_3|GPIO_Pin_4|GPIO_Pin_5|GPIO_Pin_6|GPIO_Pin_7;
	GPIO_Init(DB0TO7GPIO, &GPIO_InitStructure);

	GPIO_InitStructure.GPIO_Pin = LCD_RS|LCD_WR|LCD_CS|LCD_RST|LCD_RD;
